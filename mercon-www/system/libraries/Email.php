...
class CI_Email {
	...
	var	$smtp_host		= "mail.centralinfo.com.au";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "relay@ci-mail.centralinfo.com.au";		// SMTP Username
	var	$smtp_pass		= "cispass123";		// SMTP Password
